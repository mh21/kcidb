...
def test_url_caching(empty_deployment):
        ...
        "tests": [
            {
                ...
                "id": "_:1",
                "origin": "_",
                "log_url": "https://drive.google.com/u/0/uc?id=1EeWjyLJG3f8K7U2SxwOGYnAvSG01YM4g&export=download",
            },
            {
                "build_id": "kernelci:kernelci.org:64147283e6021132258c86c0",
                "id": "_:1",
                ...
                "environment": {
                    ...
                    "misc": {
                        "rootfs_url": "http://storage.kernelci.org/images/rootfs/buildroot/buildroot-baseline/20230120.0/armel/rootfs.cpio.gz"
                    }
                },
            },
        ],
    ...
    deadline_time = current_time + 300
    ...
    urls_not_expected = [
        ...
        "https://drive.google.com/u/0/uc?id=1EeWjyLJG3f8K7U2SxwOGYnAvSG01YM4g&export=download",

        # Wrong hash URL
        "https://github.com/kernelci/kcidb/blob/main/Dockerfile?padding=200",

        # URL from a wrong field
        "http://storage.kernelci.org/images/rootfs/buildroot/buildroot-baseline/20230120.0/armel/rootfs.cpio.gz",
    ]
