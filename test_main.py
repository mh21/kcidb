...
def test_url_caching(empty_deployment):
                ...
                "output_files": [
                    {
                        ...
                        "url":
                            "https://github.com/kernelci/kcidb/"
                            "blob/main/Dockerfile?padding=200"
                    },
                    {
                        "name": "kernel",
        ...
        "tests": [
            ...
            },
            {
                ...
                "environment": {
                    ...
                    "misc": {
                        "rootfs_url":
                            "http://storage.kernelci/buildroot-baseline"
                            "/20230120.0/armel/rootfs.cpio.gz"
                    }
                },
            },
        ],
    ...
    urls_not_expected = [
        ...
        "http://storage.kernelci/buildroot-baseline/20230120.0/"
        "armel/rootfs.cpio.gz",
    ]
